	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-primary/35 bg-primary/10 text-primary hover:bg-primary/18 aria-expanded:bg-primary/18 aria-expanded:text-primary shadow-xs",
				secondary: "bg-primary/18 text-primary hover:bg-primary/26 aria-expanded:bg-primary/26 aria-expanded:text-primary",
				ghost: "bg-primary/6 text-primary hover:bg-primary/16 hover:text-primary dark:bg-primary/10 dark:hover:bg-primary/20 aria-expanded:bg-primary/16 aria-expanded:text-primary",
				glass: "border-white/10 bg-black/45 text-primary shadow-md backdrop-blur-lg hover:bg-black/60",
