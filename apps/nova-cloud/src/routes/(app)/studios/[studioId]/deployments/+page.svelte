		...
		<section class="rounded-[2.25rem] border border-border/70 bg-background/85 p-6 shadow-sm backdrop-blur sm:p-8">
			<div class="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
				...
				<div class="flex flex-wrap gap-3">
					<Button variant="outline" class="rounded-full px-5" href={`/studios/${data.studioId}/sandbox`}>
						Open sandbox
					</Button>
						...
						<div class="rounded-[1.75rem] border border-border/60 bg-background/75 p-5">
							<div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
								...
								<div class="flex flex-wrap gap-2">
									...
									{:else}
										<Button variant="outline" size="sm" class="rounded-full" href={`/studios/${data.studioId}/sandbox`}>
											Open sandbox
										</Button>
									{/if}
								</div>
