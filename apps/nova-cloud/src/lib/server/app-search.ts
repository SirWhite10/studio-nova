  ...
  for (const chat of chats as any[]) {
    if (includesQuery(chat.title, query)) {
      results.push({
        ...
        href: `/studios/${chat.studioId}/chat/${chat._id}`,
        section: "Chats",
    ...
    const studioPages: StudioShellSearchResult[] = [
      {
        ...
        href: `/studios/${input.selectedStudioId}/agents`,
        section: "Agent",
      ...
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/memory`,
        section: "Agent",
        studioId: input.selectedStudioId,
        priority: 13,
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/marketplace`,
      ...
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/files`,
        section: "Content",
        studioId: input.selectedStudioId,
        priority: 17,
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/collections`,
        section: "Content",
        studioId: input.selectedStudioId,
        priority: 18,
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/media`,
        section: "Content",
        studioId: input.selectedStudioId,
        priority: 19,
      },
      {
        ...
        href: `/studios/${input.selectedStudioId}/sandbox`,
    ...
    for (const workspace of workspaces as any[]) {
      if (includesQuery(workspace.name, query) || includesQuery(workspace.slug, query)) {
        results.push({
          ...
          href: `/studios/${input.selectedStudioId}/deployments`,
          section: "Deployments",
          studioId: input.selectedStudioId,
          priority: 25,
        });
