...
<div
	class={cn("mx-auto flex w-full max-w-md flex-col gap-6 md:max-w-2xl lg:max-w-4xl", className)}
	{...restProps}
>
	<Card.Root class="overflow-hidden p-0">
		<Card.Content class="grid p-0 lg:grid-cols-2">
			<form class="p-6 md:p-8" onsubmit={handleSubmit}>
				<FieldGroup>
					...
					<Field class="flex gap-3">
						...
						{#if passwordStep}
							<Button type="button" variant="outline" onclick={resetEmailStep}>
								Back
							</Button>
						{/if}
					</Field>
